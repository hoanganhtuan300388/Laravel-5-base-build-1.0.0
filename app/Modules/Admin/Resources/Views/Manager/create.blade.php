...
@section('content_header')
    @include('Admin::Elements.content_header', [
        'title'         => __('manager'),
        'description'   => __('add new'),
        'breadcrumb'    => [
            'admin.managers.index'  => 'manager',
            'admin.managers.create' => 'add new'
        ]
    ])
@endsection
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                {!! Form::model($manager, ['route' => 'admin.managers.store', 'method' => 'POST', 'class' => 'form-horizontal', 'files' => true]) !!}
                    <div class="box-body">
                        ...
                        <div class="form-group {{ $errors->has('password_flg') ? 'has-error' : '' }}">
                            {!! Form::label('password_flg', __('password') . ' *', ['class' => 'col-sm-2 control-label']) !!}
                            <div class="col-sm-5">
                                {!! Form::password('password_flg', ['class' => 'form-control input-sm', 'maxlength' => 255]) !!}
                                {!! $errors->first('password_flg', '<span class="help-block">:message</span>') !!}
                            </div>
                        </div>
